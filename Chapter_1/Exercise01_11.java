...
public class Exercise01_11{
    ...
    public static void main(String args[]){
		...
		System.out.println( "Population after 1 Year: " + ( 312032486 + 1*((3.154e+7 / 7) + (3.154e+7 / 45) - (3.154e+7 / 13))) );
		
		System.out.println( "Population after 2 Year: " + ( 312032486 + 2*((3.154e+7 / 7) + (3.154e+7 / 45) - (3.154e+7 / 13))) );
		
		System.out.println( "Population after 3 Year: " + ( 312032486 + 3*((3.154e+7 / 7) + (3.154e+7 / 45) - (3.154e+7 / 13))) );

		System.out.println( "Population after 4 Year: " + ( 312032486 + 4*((3.154e+7 / 7) + (3.154e+7 / 45) - (3.154e+7 / 13))) );
		
		System.out.println( "Population after 5 Year: " + ( 312032486 + 5*((3.154e+7 / 7) + (3.154e+7 / 45) - (3.154e+7 / 13))) );
